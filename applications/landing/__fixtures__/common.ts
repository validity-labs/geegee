...
export const reviews: Quote[] = [
  ...
  {
    id: "2",
    quote: "Sunt nisi cillum mollit sit dolor ut in deserunt. Enim sunt nisi sit deserunt deserunt. Deserunt laborum eu aute anim voluptate ut mollit laborum elit amet exercitation. Consectetur ipsum duis cillum ea elit elit aliqua ut ut cupidatat elit. Duis consequat fugiat mollit laborum et enim nisi. Veniam pariatur id aute sit Lorem. Incididunt enim reprehenderit qui ea aliqua culpa dolore.",
    name: "Jim Doe",
    position: "Developer",
    portrait: {
      "url": "example.jpg",
  ...
  {
    id: "3",
    quote: "Esse elit excepteur exercitation ipsum pariatur quis eu mollit commodo esse incididunt irure et. Proident exercitation sit elit proident et. Deserunt ea tempor proident exercitation anim.",
    name: "Jane Doe",
    position: "Designer",
    portrait: {
      "url": "example.jpg",
